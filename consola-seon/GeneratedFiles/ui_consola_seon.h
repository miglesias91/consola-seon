...
public:
    ...
    void setupUi(QMainWindow *consola_seonClass)
    {
        ...
        panel_superior->setSizeConstraint(QLayout::SetMaximumSize);
...
"border-left: 0px;"));
        ...
        frame_testigo_pantalla = new QFrame(widget_latera);
        ...
        frame_testigo_camara = new QFrame(widget_latera);
        ...
        frame_testigo_foco = new QFrame(widget_latera);
        ...
        frame_testigo_enganche = new QFrame(widget_latera);
...
"color: rgb(250, 250, 0);"));
        ...
        frame_testigo_modo = new QFrame(widget_latera);
        ...
        frame_testigo_video = new QFrame(widget_latera);
        ...
        frame_testigo_ventana_optica = new QFrame(widget_latera);
        ...
        frame_testigo_zoom = new QFrame(widget_latera);
