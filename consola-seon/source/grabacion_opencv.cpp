...
grabacion_opencv::grabacion_opencv(seon::video::administrador * admin_video, QWidget * padre)
    ...
    grabador_video(admin_video->configuracion.grabacion.path, admin_video->configuracion.grabacion.fps, admin_video->configuracion.grabacion.resolucion.ancho, admin_video->configuracion.grabacion.resolucion.alto)
{
