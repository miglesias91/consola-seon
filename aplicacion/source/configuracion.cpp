...
bool configuracion::levantar(const std::string & path_configuracion)
{
    ...
    this->config_comunicacion.levantar(configuracion_json.getAtributoValorString("config_comunicacion"));
...
std::string configuracion::detallado()
{
    return
        ...
        "COMUNICACION: " + this->config_comunicacion.path.u8string() + "\n" + this->config_comunicacion.detallado + "\n" +
